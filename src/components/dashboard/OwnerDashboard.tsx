              ...
              <div className="flex items-center space-x-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 font-medium">Owner Dashboard</p>
                  </div>
                </div>
              </div>
              <div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="bg-gradient-to-br from-emerald-500 to-green-600 text-white border-0 shadow-xl hover:shadow-2xl transition-shadow">
              ...
              <CardContent>
                ...
                <p className="text-xs text-emerald-100 mt-1">All time revenue</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-rose-500 to-pink-600 text-white border-0 shadow-xl hover:shadow-2xl transition-shadow">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-rose-100">Total Expenses</CardTitle>
            ...
            <Card className="bg-gradient-to-br from-purple-500 to-violet-600 text-white border-0 shadow-xl hover:shadow-2xl transition-shadow">
              ...
              <CardContent>
                <div className="text-3xl font-bold">₱{stats.todaysRevenue.toFixed(2)}</div>
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-orange-100 shadow-xl">
            <CardHeader className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-t-lg">
              ...
              <CardDescription className="text-orange-100">Latest sales and expenses from your business</CardDescription>
            </CardHeader>
                        ...
                        <div>
                          <p className="font-semibold text-gray-800">
                            ...
                            {transaction.workerEmail && (
                              <span className="text-sm text-gray-500 ml-2 font-normal">by {transaction.workerEmail}</span>
                            )}
                          </p>
