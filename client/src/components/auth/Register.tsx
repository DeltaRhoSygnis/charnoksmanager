  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-1/2 h-1/2 bg-gradient-to-l from-yellow-500/10 to-transparent rounded-full blur-2xl animate-pulse delay-500"></div>
      </div>
