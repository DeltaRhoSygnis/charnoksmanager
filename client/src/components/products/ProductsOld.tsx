...
const productFormSchema = insertProductSchema.extend({
  price: insertProductSchema.shape.price.transform((val) => parseFloat(val as string)),
  stock: insertProductSchema.shape.stock.transform((val) => parseInt(val as string)),
});
